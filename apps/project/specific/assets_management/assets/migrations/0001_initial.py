    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50, verbose_name='category (EN)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='description')),
                ('quantity_type', models.CharField(choices=[('O', 'Other'), ('U', 'Units'), ('B', 'Boxes'), ('C', 'Containers')], default='U', max_length=255, verbose_name='quantity type')),
                ('total_quantity', models.BigIntegerField(default=0, verbose_name='total lump sum')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='asset_assetcategory', to='assets.assetcategorymodel', verbose_name='category')),
            ],
            options={
                'verbose_name': 'Asset',
